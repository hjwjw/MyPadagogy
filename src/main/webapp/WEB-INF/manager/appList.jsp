									...
									<c:forEach items="${appList}" var="appItem">
										<tr>
											...
											<td class="text-center">
												...
												<a class="btn btn-danger" href="appItem/changeStateById/${appItem.appId }">不通过</a>
												<a class="btn btn-danger" href="appItem/del/${appItem.appId }">删除</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
       	   ...
       	   $("#init_btn").click(function(e) {
       	   	...
       	   	if(init_btn.length==0){
       	   		...
       	   		return false;
       	   			...
       	   			alert(str);
       	   			if(str == "del"){
       	   				$('form[id=appListForm]').attr('action','appItem/selectDel');
       	   				$('form[id=appListForm]').submit();
       	   			}else if(str == "no"){
       	   				$('form[id=appListForm]').attr('action','appItem/changeState');
       	   				$('form[id=appListForm]').submit();
       	   			}
